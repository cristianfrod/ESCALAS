    ...
    <div class="center">
      ...
      <form class="login" method="post">
        <div class="col-md-3">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title"><strong>1 </strong>Selecione de quem é a escala</h3>
            </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-md-12">
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="ownerDate">Data da escala</label>
        ...
        <div class="col-md-3">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title"><strong>2 </strong>Selecione quem vai tirar a escala</h3>
            </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-md-12">
        ...
        <div class="col-md-3">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title"><strong>3 </strong>Confirmar Ajuste</h3>
            </div>
            <div class="panel-body">
              <?php if($message){?>
              <div class="row">
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <input class="btn btn-sm btn-primary btn-block" type="submit" name="submit" value="EFETUAR AJUSTE!">
                </div>
              </div>
            </div>
          </div>
