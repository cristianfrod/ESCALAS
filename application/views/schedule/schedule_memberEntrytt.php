<div class="container">
	<div class="content">
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">Escale um Usuário</h3>
					</div>
		...
		<!-- <div class="form-group row">
			<div class="col-xs-12">
				<label class="col-form-label" for="userSelection">Equipe</label>
				<select class="form-control col-xs-12" name="userSelection" required>
